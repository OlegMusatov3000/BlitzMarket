...
from ads.models import Ad, AdType, Comment, Complaint
from ads.schemas import AdCreate, CommentCreate, ComplaintCreate
...
@router.get("/complaints", responses={
...
@router.post("/{ad_id}/complaints", status_code=201, responses={
